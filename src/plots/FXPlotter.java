...
import operations.ApplyNormalization;
...
//        trainingLabels.setRow(0, 0, 0, 1, 1, 0);
    ...
    public void readData() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader("D:\\Carpetas\\Documentos\\Java\\CC5114-1\\Tarea1\\src\\datasets\\iris.data"));
            while (k < 150){
                line = br.readLine();
